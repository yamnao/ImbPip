...
class gsmote():
    ...
    def get_parameters_combination(self):
        dico = {'truncation_factor': [-1, -0.5, 0.5, 1],
                'deformation_factor': [0, 0.2, 0.4, 0.6, 1],
    ...
    def fit_sample(self, X, y):
        ...
        # Resample data
        for class_label, n_samples in _sampling_strategy_not_majority(y, 'over-sampling').items():
